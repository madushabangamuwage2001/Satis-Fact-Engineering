  ...
  const projects = [
    {
      ...
      description: "Premium residential development featuring eco-friendly design and high-end finishes.",
    ...
    },
    {
      ...
      description: "Cutting-edge office complex with smart technology and sustainable systems.",
      category: "Commercial",
    },
    {
      id: 3,
      ...
      description: "Advanced logistics hub with optimized storage and operational efficiency.",
      category: "Industrial",
    },
    {
      id: 4,
      ...
      description: "Meticulous restoration preserving historical architecture with modern upgrades.",
    ...
    <div className="pt-17 bg-gray-50">
      ...
      >
        ...
        >
          ...
          >
            <span className="block text-white drop-shadow-lg">Building Dreams</span>
          ...
          >
            Delivering unparalleled construction and maintenance services with a commitment to quality and excellence.
          </motion.p>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-red-600">Our Featured Projects</h2>
            <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
              Explore our portfolio of exceptional construction projects showcasing our expertise and dedication.
            </p>
          </motion.div>
            ...
            <AnimatePresence>
              {projects.map((project, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-semibold text-red-600 mb-2">{project.title}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8">
                We offer end-to-end solutions for residential, commercial, and industrial projects, ensuring quality and precision in every detail.
              </p>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-red-600">Why Choose Satis-Fact?</h2>
            <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
              Our commitment to quality, reliability, and client satisfaction sets us apart in the construction industry.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "ICTAD certified, ensuring top-tier workmanship and materials in every project.",
              },
              {
                icon: "fas fa-clock",
                title: "On-Time Delivery",
                description: "We prioritize your schedule, delivering projects promptly without sacrificing quality.",
              },
              {
                icon: "fas fa-handshake",
                title: "Client-Centric Approach",
                description: "Your vision drives us. We collaborate closely to exceed your expectations.",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-red-600 mb-2">{feature.title}</h3>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">Ready to Build Your Vision?</h2>
            <p className="text-lg mb-8 max-w-3xl mx-auto">
              Start your construction or maintenance project with a free estimate. Contact us today to bring your ideas to life.
            </p>
          </motion.div>
